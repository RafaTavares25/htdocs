...
export const EditarCli = (props) => {
    const [id1, setId] = useState(props.match.params.id)
    ...
    const cadCliente = async e => {
        ...
        await axios.put(api + "/attcliente/", cliente, { headers })
            .then((response) => {
    ...
    return (
        <Container>
            <div className="d-flex">
                ...
                <div className="p-2">
                    <Link to="/listar-clientes" className="btn btn-outline-success btn-sm">Voltar</Link>
                </div>
            </div>
            ...
            <Form className="p-2" onSubmit={cadCliente}>
                <FormGroup className="p-2">
                    <Label ></Label>
                    <Input name="id" placeholder="ID do Cliente" type="text" value={id1}
                        onChange={valorInput} />    
                </FormGroup>
                <FormGroup className="p-2">
                    <Label >Nome</Label>

...
export const CadastrarItemP = (props) => {
    ...
    const cadPedido = async e =>{
        ...
        await axios.post(api+"/itempedido", itemp,{headers})
        .then((response) =>{
        ...
        <Container>
            ...
            <Form className="p-2" onSubmit={cadPedido}>
                <FormGroup className="p-2">
                    ...
                    <Input name="PedidoId" placeholder="Id do Pedido" type="number" 
                        onChange={valorInput}/>
                </FormGroup>

                <FormGroup className="p-2">
                    <Label >ID do Serviço</Label>
                    <Input name="ServicoId" placeholder="Id do Serviço" type="number" 
                        onChange={valorInput}/>
                </FormGroup>
